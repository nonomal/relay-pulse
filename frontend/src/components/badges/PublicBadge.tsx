...
export function PublicBadge({ className = '' }: PublicBadgeProps) {
  ...
  return (
    ...
    >
      ...
      <span className="absolute top-full left-0 mt-1 px-2 py-1 bg-elevated text-primary text-xs rounded opacity-0 group-hover/public:opacity-100 pointer-events-none transition-opacity delay-700 whitespace-nowrap z-50">
